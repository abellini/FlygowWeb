Ext.define('ExtDesktop.controller.Registrations.Food.FoodController', {
    extend: 'Ext.app.Controller',
	itemId: 'crudfood',
	// getters for views
    refs: [{
        selector: 'grid[itemId=crudfoodgrid]',
        ref: 'gridCrud'
    },{
        selector: 'form[itemId=crudfoodform]',
        ref: 'formCrud'
    },{
		selector: 'button[itemId=crudfoodgriddelete]',
        ref: 'btnDelete'
	}],
	init: function(){
		var me = this;
		me.control({
			'grid[itemId=crudfoodgrid]' : {
                afterrender: me.onRenderGrid.bind(me)
            },
			'button[itemId=crudfoodformregister]': {
                click: me.onRegisterBtn.bind(me)
            },
            'button[itemId=crudfoodformreset]': {
				click: me.onResetBtn.bind(me)
			},
			'button[itemId=crudfoodgriddelete]': {
