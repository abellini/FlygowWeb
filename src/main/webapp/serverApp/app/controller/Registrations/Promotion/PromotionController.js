Ext.define('ExtDesktop.controller.Registrations.Promotion.PromotionController', {
    extend: 'Ext.app.Controller',
	itemId: 'crudpromotion',
	// getters for views
    refs: [{
        selector: 'grid[itemId=crudpromotiongrid]',
        ref: 'gridCrud'
    },{
        selector: 'form[itemId=crudpromotionform]',
        ref: 'formCrud'
    },{
		selector: 'button[itemId=crudpromotiongriddelete]',
        ref: 'btnDelete'
	}],
	init: function(){
		var me = this;
		me.control({
			'grid[itemId=crudpromotiongrid]' : {
                afterrender: me.onRenderGrid.bind(me)
            },
			'button[itemId=crudpromotionformregister]': {
                click: me.onRegisterBtn.bind(me)
            },
            'button[itemId=crudpromotionformreset]': {
				click: me.onResetBtn.bind(me)
			},
			'button[itemId=crudpromotiongriddelete]': {
