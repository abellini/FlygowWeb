Ext.define('ExtDesktop.controller.Registrations.OperationalArea.OperationalAreaController', {
    extend: 'Ext.app.Controller',
	itemId: 'operationalarea',
	// getters for views
    refs: [{
        selector: 'grid[itemId=operationalareagrid]',
        ref: 'gridCrud'
    },{
        selector: 'form[itemId=operationalareaform]',
        ref: 'formCrud'
    },{
		selector: 'button[itemId=operationalareagriddelete]',
        ref: 'btnDelete'
	}],
	init: function(){
		var me = this;
		me.control({
			'grid[itemId=operationalareagrid]' : {
                afterrender: me.onRenderGrid.bind(me)
            },
			'button[itemId=operationalareaformregister]': {
                click: me.onRegisterBtn.bind(me)
            },
            'button[itemId=operationalareaformreset]': {
				click: me.onResetBtn.bind(me)
			},
			'button[itemId=operationalareagriddelete]': {
