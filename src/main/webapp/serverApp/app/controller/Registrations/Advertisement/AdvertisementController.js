Ext.define('ExtDesktop.controller.Registrations.Advertisement.AdvertisementController', {
    extend: 'Ext.app.Controller',
	itemId: 'crudadvertisement',
	// getters for views
    refs: [{
        selector: 'grid[itemId=crudadvertisementgrid]',
        ref: 'gridCrud'
    },{
        selector: 'form[itemId=crudadvertisementform]',
        ref: 'formCrud'
    },{
		selector: 'button[itemId=crudadvertisementgriddelete]',
        ref: 'btnDelete'
	},{
		selector: 'image[itemId=crudadvertisementimg]',
        ref: 'imgCrud'
	}],
	init: function(){
		var me = this;
		me.control({
			'grid[itemId=crudadvertisementgrid]' : {
                afterrender: me.onRenderGrid.bind(me)
            },
			'button[itemId=crudadvertisementformregister]': {
                click: me.onRegisterBtn.bind(me)
            },
            'button[itemId=crudadvertisementformreset]': {
				click: me.onResetBtn.bind(me)
			},
			'button[itemId=crudadvertisementgriddelete]': {
