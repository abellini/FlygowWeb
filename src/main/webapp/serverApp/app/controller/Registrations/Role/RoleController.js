Ext.define('ExtDesktop.controller.Registrations.Role.RoleController', {
    extend: 'Ext.app.Controller',
	itemId: 'crudrole',
	// getters for views
    refs: [{
        selector: 'grid[itemId=crudrolegrid]',
        ref: 'gridCrud'
    },{
        selector: 'form[itemId=crudroleform]',
        ref: 'formCrud'
    },{
		selector: 'button[itemId=crudrolegriddelete]',
        ref: 'btnDelete'
	}],
	init: function(){
		var me = this;
		me.control({
			'grid[itemId=crudrolegrid]' : {
                afterrender: me.onRenderGrid.bind(me)
            },
			'button[itemId=crudroleformregister]': {
                click: me.onRegisterBtn.bind(me)
            },
            'button[itemId=crudroleformreset]': {
				click: me.onResetBtn.bind(me)
			},
			'button[itemId=crudrolegriddelete]': {
