Ext.define('ExtDesktop.controller.Registrations.Tablet.TabletController', {
    extend: 'Ext.app.Controller',
	itemId: 'crudtablet',
	// getters for views
    refs: [{
        selector: 'grid[itemId=crudtabletgrid]',
        ref: 'gridCrud'
    },{
        selector: 'form[itemId=crudtabletform]',
        ref: 'formCrud'
    },{
		selector: 'button[itemId=crudtabletgriddelete]',
        ref: 'btnDelete'
	}],
	init: function(){
		var me = this;
		me.control({
			'grid[itemId=crudtabletgrid]' : {
                afterrender: me.onRenderGrid.bind(me)
            },
			'button[itemId=crudtabletformregister]': {
                click: me.onRegisterBtn.bind(me)
            },
            'button[itemId=crudtabletformreset]': {
				click: me.onResetBtn.bind(me)
			},
			'button[itemId=crudtabletgriddelete]': {
