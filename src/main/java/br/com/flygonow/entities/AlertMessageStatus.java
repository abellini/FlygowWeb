...
@Entity
@Table(name = "AlertMessageStatus")
public class AlertMessageStatus implements Serializable {
	...
	@Id
	@GeneratedValue(strategy=GenerationType.AUTO, generator="alert_message_status_gen")	
	@SequenceGenerator(name = "alert_message_status_gen", sequenceName = "seq_alert_message_status")
	private Long id;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		AlertMessageStatus other = (AlertMessageStatus) obj;
		if (alerts == null) {
